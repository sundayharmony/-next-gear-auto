...
export function RentalAgreementInline({
  ...
  const balanceDue = (totalPrice || 0) - 50; // $50 security deposit

  return (
    <div className="bg-white rounded-lg border border-gray-200 overflow-y-auto max-h-[500px] text-[13px] leading-relaxed text-gray-800">
      {/* ═══ PAGE 1 ═══ */}
      <div className="p-6 pb-4">
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-2">
            <div>
              ...
              <Field value={vehicle ? `${vehicle.make} ${vehicle.model}` : undefined} width="180px" />
            </div>
            <div>
              <span className="font-semibold">Year:</span>{" "}
              <Field value={vehicle?.year} width="80px" />
            </div>
            <div>
              <span className="font-semibold">License Plate:</span>{" "}
              <Field value={vehicle?.licensePlate} width="120px" />
            </div>
            <div>
              <span className="font-semibold">VIN:</span>{" "}
              <Field value={vehicle?.vin} width="180px" />
            </div>
            <div>
              <span className="font-semibold">Color:</span>{" "}
              <Field value={vehicle?.color} width="100px" />
            </div>
            <div>
              <span className="font-semibold">Mileage:</span>{" "}
              <Field
                value={vehicle?.mileage ? `${Number(vehicle.mileage).toLocaleString()} mi` : undefined}
                width="120px"
              />
            </div>
          </div>
          <div className="mt-2">
            ...
            <span className="inline-flex gap-3 ml-2">
              <label className="inline-flex items-center gap-1">
                <span className="w-3.5 h-3.5 border border-gray-400 rounded-sm inline-block" /> Excellent
              </label>
              <label className="inline-flex items-center gap-1">
                <span className="w-3.5 h-3.5 border border-gray-400 rounded-sm inline-block bg-purple-600" /> Good
              </label>
              <label className="inline-flex items-center gap-1">
                <span className="w-3.5 h-3.5 border border-gray-400 rounded-sm inline-block" /> Fair
              </label>
              <label className="inline-flex items-center gap-1">
                <span className="w-3.5 h-3.5 border border-gray-400 rounded-sm inline-block" /> Poor
              </label>
            </span>
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-2">
            <div>
              ...
              <Field value={customerName} width="180px" />
            </div>
            <div>
            ...
            <div>
              ...
              <Field value={customerPhone} width="150px" />
            </div>
            <div>
              <span className="font-semibold">Email:</span>{" "}
              <Field value={customerEmail} width="200px" />
            </div>
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <p className="font-semibold text-gray-900">
            Late Fee Policy: $75 per hour. Any time after 59 minutes late will be charged as a full
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-1 gap-y-2 mb-2">
            <div>
              <span className="font-semibold">Primary Renter (age 18+):</span>{" "}
              <Field value={customerName} width="200px" />
              <span className="ml-4 font-semibold">Driver&apos;s Lic:</span>{" "}
              <Field width="120px" />
            </div>
            <div>
              <span className="font-semibold">Additional Driver (age 18+):</span>{" "}
              <Field width="200px" />
              <span className="ml-4 font-semibold">Driver&apos;s Lic:</span>{" "}
              <Field width="120px" />
            </div>
          ...
          <p className="text-gray-700">
            Only these two drivers are authorized to operate this vehicle. Unauthorized drivers will result
            in: $750 penalty, full liability for all damage, and immediate agreement termination.
          </p>
        </div>
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-2 mb-2">
            <div>
              ...
              <Field value={totalPrice ? totalPrice.toFixed(2) : undefined} width="100px" />
            </div>
            <div>
              <span className="font-semibold">Total Days:</span>{" "}
              <Field value={totalDays} width="60px" />
            </div>
            <div>
              <span className="font-semibold">Security Deposit:</span> $50.00
            </div>
            <div>
              <span className="font-semibold">Balance Due at Pickup: $</span>{" "}
              <Field value={balanceDue > 0 ? balanceDue.toFixed(2) : "0.00"} width="100px" />
            </div>
          </div>
          <div className="mb-2">
            ...
            <span className="inline-flex gap-3 ml-2">
              <label className="inline-flex items-center gap-1">
                <span className="w-3.5 h-3.5 border border-gray-400 rounded-sm inline-block" /> Cash
              </label>
              <label className="inline-flex items-center gap-1">
                <span className="w-3.5 h-3.5 border border-gray-400 rounded-sm inline-block" /> Zelle
              </label>
              <label className="inline-flex items-center gap-1">
                <span className="w-3.5 h-3.5 border border-gray-400 rounded-sm inline-block bg-purple-600" />{" "}
                Credit/Debit
              </label>
            </span>
          </div>
          <p className="text-gray-700">
            <strong>Included:</strong> 200 miles per day
          </p>
          <p className="text-gray-700">
            <strong>Extra Miles:</strong> $0.39 per mile over 200/day
          </p>
        </div>
      ...
      {/* ═══ PAGE 2 ═══ */}
      <div className="p-6 pt-4 pb-4 border-t-2 border-purple-200">
        {/* Section 5 */}
        <div className="mb-5">
          <h3 className="font-bold text-sm text-gray-900 border-b border-gray-300 pb-1 mb-2">
          ...
          <p className="mb-2 text-gray-700">
            Renter MUST provide proof of active auto insurance meeting New Jersey minimum requirements.
          </p>
          <div className="grid grid-cols-3 gap-x-4 gap-y-2 mb-2">
            <div>
              <span className="font-semibold">Insurance Provider:</span> <Field width="120px" />
            </div>
            <div>
              <span className="font-semibold">Policy #:</span> <Field width="120px" />
            </div>
            <div>
              <span className="font-semibold">Phone:</span> <Field width="120px" />
            </div>
          </div>
          <p className="text-gray-700 mb-1">
            If proof of insurance is not provided, temporary Non-Owned Auto Coverage will be added at
            $12/day.
          </p>
          <p className="text-gray-700">
            <strong>Optional Supplemental Liability Protection (SLP):</strong> $14.99/day (up to $1M)
          </p>
        </div>
        ...
        <div className="mb-5">
          <h3 className="font-bold text-sm text-gray-900 border-b border-gray-300 pb-1 mb-2">
            6. LIABILITY & DAMAGE RESPONSIBILITY
          </h3>
          <p className="text-gray-700">
        ...
        <div className="mb-5">
          ...
          <p className="mb-2 text-gray-700">
            The following are strictly prohibited ($1,500 penalty + full liability):
          </p>
        ...
        <div className="mb-5">
          <h3 className="font-bold text-sm text-gray-900 border-b border-gray-300 pb-1 mb-2">
            9. GPS / VEHICLE TRACKING DISCLOSURE
          </h3>
          ...
          <p className="font-semibold text-gray-900">
            I acknowledge and consent to GPS/vehicle tracking during the rental period.
          </p>
        </div>

        <div className="border-t border-dashed border-gray-300 my-4" />
        <p className="text-center text-[11px] text-gray-400 italic">
          Page 2 of 3 — GPS Acknowledgement & Renter Initials Required
        </p>
      </div>

      {/* ═══ PAGE 3 ═══ */}
      <div className="p-6 pt-4 border-t-2 border-purple-200">
        {/* Section 10 */}
        <div className="mb-5">
          <h3 className="font-bold text-sm text-gray-900 border-b border-gray-300 pb-1 mb-2">
            10. PETS & CLEANLINESS
        ...
        {/* Signatures Section */}
        <div className="mb-4">
          <h3 className="font-bold text-sm text-gray-900 border-b-2 border-gray-900 pb-1 mb-2">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-x-6">
              <div>
                <span className="font-semibold">Renter Name (Print):</span>{" "}
                <Field value={customerName} width="200px" />
              </div>
              <div>
                <span className="font-semibold">Date:</span> <Field width="120px" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-x-6">
              <div>
                <span className="font-semibold">Renter Signature:</span>{" "}
                <Field width="250px" />
              </div>
              <div>
                <span className="font-semibold">Time:</span> <Field width="120px" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-x-6">
              <div>
                <span className="font-semibold">NGA Representative:</span>{" "}
                <Field value="NextGear Auto" width="200px" />
              </div>
              <div>
                <span className="font-semibold">Date:</span> <Field width="120px" />
              </div>
        ...
        <div className="border-t border-dashed border-gray-300 my-4" />
        <p className="text-center text-[11px] text-gray-400 italic">
          Page 3 of 3 — Full Signature & Final Initials Required
        </p>
      </div>
    </div>
  );
