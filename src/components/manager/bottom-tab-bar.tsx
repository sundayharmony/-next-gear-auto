...
import { LayoutDashboard, MoreHorizontal, X, Moon, Sun } from "lucide-react";
...
export function ManagerBottomTabBar() {
  ...
  return (
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 shrink-0 z-[91] lg:hidden" aria-label="Manager navigation">
