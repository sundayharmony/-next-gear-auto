...
-- Replace stale definitions to guarantee manager-safe values are allowed.
ALTER TABLE bookings
  DROP CONSTRAINT IF EXISTS bookings_origin_channel_check;
...
-- Keep role list constrained (replace stale definitions that may exclude manager)
ALTER TABLE customers
