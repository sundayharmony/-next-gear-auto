    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://js.stripe.com https://maps.googleapis.com https://www.googletagmanager.com https://www.instagram.com https://*.instagram.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https://images.unsplash.com https://via.placeholder.com https://maps.googleapis.com https://*.stripe.com https://*.supabase.co https://*.cdninstagram.com https://*.fbcdn.net https://*.instagram.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' blob: https://api.stripe.com https://checkout.stripe.com https://*.supabase.co https://maps.googleapis.com https://*.instagram.com; frame-src 'self' https://js.stripe.com https://checkout.stripe.com https://www.google.com https://maps.google.com https://www.instagram.com https://*.instagram.com;",
          },
        ],
      },
    ];
